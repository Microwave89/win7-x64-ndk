...
3.1 ORGANIZATION
   ...
   * The NDK can either be included on-demand (#include <..\ndk\ndk/xxxxx.h>) or globally (#include <..\ndk\ndk/ntndk.h>).
...
3.2 USING IN YOUR PROJECT
	...
	**********************Currently Only AMD64 Supported!!!!**********************
        ***********Currently Only Tested With Visual Studio 2013 & WDK 8.1!***********

	- Copy folder "ndk" in your Windows Kits\8.1\Include directory. (In the dir you must see folders such as km, um, shared, ...)
	- Add following to your "global.h" file:
    ...
    * Kernel Mode Driver: 
       ...
       #include "ntifs.h"       /* Declare DDK Headers like you normally would */
       #include "ntndk.h"       /* Declare the NDK Headers */
